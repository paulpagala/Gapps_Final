...
export default function LandingPage() {
  ...
  function FindParkingAreas() {
    ...
    fetch(
      ...
      .then((response) => {
       setParkingAreas(response.ParkingAreas)
  ...
  const handleClick = (e) => {
    ...
    signInWithPopup(auth, provider)
      .then((result) => {
        ...
        // alert(username);
        {parkingAreas.length===0 ? router.push('/landingPage') : router.push('/parkingDashboard')}

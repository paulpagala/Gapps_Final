  ...
  postParkingArea('https://zh66xn42vk.execute-api.ap-southeast-1.amazonaws.com/stage/parkingarea',
    {
      ...
      "bookingStart":bookingStart[dayIndex],
      "bookingEnd":bookingEnd[dayIndex],
      "day":day,
      "week":week,
      "service":"Parking",
...
parkingAreaName.map((parkingArea,indexParkingArea)=>(parkingAreaFloor[indexParkingArea].map((parkingFloor,indexParkingAreaFloor)=>(parkingSlotNames[indexParkingArea][indexParkingAreaFloor].map((parkingNameSlots,indexParkingNameSlots)=>(
  postParkingArea('https://zh66xn42vk.execute-api.ap-southeast-1.amazonaws.com/stage/parkingslotname',
{
  "parkingAreaName": parkingArea,
  "parkingAddress": parkingAreaAddress[indexParkingArea],
  // "parkingAreaFloor":parkingAreaFloor[indexParkingArea][indexParkingAreaFloor],
  "parkingAreaFloor":parkingFloor,
  // "parkingAreaSlots":parkingAreaSlots[indexParkingArea][indexParkingAreaFloor],
  "parkingFloorSlotNames": parkingNameSlots
})
.then((data) => {
  console.log(data); // JSON data parsed by `data.json()` call
})
